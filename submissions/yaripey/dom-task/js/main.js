const texts = {
  ...
  finn: {
    img: "img/finn.png",
    text: [
      "Finn the Human (also known as Finn Mertens) is a fictional character and the main protagonist of the American animated television series Adventure Time created by Pendleton Ward. He is voiced by Jeremy Shada in most appearances. The character made his debut in the original pilot, where he was named Pen and voiced by Zack Shada, Jeremy's older brother.",
  ...
  marcy: {
    ...
    text: [
      ...
      "Marceline has been critically acclaimed and is popular with the Adventure Time fandom. The character was also the focus of the seventh season miniseries Stakes (2015). Early in the show's history, Ward himself stated that Marceline was his favorite character because he did not know everything about her history and backstory, which he felt added a mysterious element to her character. Marceline's relationship with Princess Bubblegum created controversy when the episodes \"What Was Missing\" and \"Sky Witch\" implied that they had been in a relationship—a relationship that was confirmed in the series finale \"Come Along with Me\"."
    ]
  },
  pb: {
    img: "img/pb.png",
    text: [
      "Princess Bonnibel Bubblegum (also called Bonnie or PB, occasionally P-bubs), is a fictional character in the American animated television series Adventure Time, created by Pendleton Ward. She is voiced by Hynden Walch.Princess Bubblegum is a \"Gum Golem\", a being composed of both human and candy DNA, and rules the Candy Kingdom, which is inhabited by other \"Candy People\". She is good friends with the series' protagonists Finn the Human and Jake the Dog, first appearing with them in Ward's 2008 pilot.",
