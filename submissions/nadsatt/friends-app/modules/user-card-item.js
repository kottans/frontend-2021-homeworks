export class UserCard {
    constructor(user){
        ...
        this.element.querySelector('.user-card__front')
            .prepend(user.frontImage, user.frontBorderImage);

        this.element.querySelector('.user-card__back')
            .prepend(user.backImage, user.backBorderImage);
    }
}
