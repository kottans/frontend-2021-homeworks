...
const menu = document.createElement('ul');
    ...
    menu.innerHTML = `<li class="menu__item active" data-item="cats">Cats</li>
    <li class="menu__item" data-item="dogs">Dogs</li>
    <li class="menu__item" data-item="lions">Lions</li>
    <li class="menu__item" data-item="tigers">Tigers</li>
    <li class="menu__item" data-item="hares">Hares</li>
    <li class="menu__item" data-item="elephants">Elephants</li>`;
...
menu.addEventListener('click', event => {
    ...
    if (event.target.classList.value === 'menu__item') {
        ...
        const dataAttribute = event.target.dataset.item;
